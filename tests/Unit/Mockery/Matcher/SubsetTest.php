...
namespace MockeryTest\Unit\Mockery\Matcher;

class SubsetTest extends \Mockery\Adapter\Phpunit\MockeryTestCase
{
    /** @test */
    public function it_matches_a_shallow_subset()
    {
        $matcher = \Mockery\Matcher\Subset::strict(['dave' => 123]);
    ...
    {
        $matcher = \Mockery\Matcher\Subset::strict(['foo' => ['bar' => ['baz' => 123]]]);
    ...
    {
        $matcher = new \Mockery\Matcher\Subset(['dave' => 123]);
    ...
    {
        $matcher = \Mockery\Matcher\Subset::loose(['dave' => 123]);
