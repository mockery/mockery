...
class ClassNamePassTest extends \Mockery\Adapter\Phpunit\MockeryTestCase
{
    ...
    {
        $this->pass = new \Mockery\Generator\StringManipulation\Pass\ClassNamePass();
    }
    ...
    {
        $config = new \Mockery\Generator\MockConfiguration(array(), array(), array(), "Dave\Dave");
    ...
    {
        $config = new \Mockery\Generator\MockConfiguration(array(), array(), array(), "Dave");
        $code = $this->pass->apply(static::CODE, $config);
