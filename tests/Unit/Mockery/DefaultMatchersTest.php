...
use MockeryTest\Fixture\CustomValueObject;
use MockeryTest\Fixture\CustomValueObjectInterface;
use MockeryTest\Fixture\CustomValueObjectMatcher;

class DefaultMatchersTest extends \Mockery\Adapter\Phpunit\MockeryTestCase
{
    protected $mock;
    ...
    public function testDefaultMatcherClass()
    {
        \Mockery::getConfiguration()
            ->setDefaultMatcher(CustomValueObject::class, CustomValueObjectMatcher::class);
    ...
    {
        \Mockery::getConfiguration()
            ->setDefaultMatcher(CustomValueObjectInterface::class, CustomValueObjectMatcher::class);
