...
use MockeryTest\Fixture\IWater;
use MockeryTest\Fixture\Mockery_Demeterowski;
use MockeryTest\Fixture\Mockery_Duck;
use MockeryTest\Fixture\Mockery_Duck_Nonswimmer;
use MockeryTest\Fixture\Mockery_Magic;
use MockeryTest\Fixture\Mockery_UseDemeter;
use MockeryTest\Fixture\MockeryTest_InterMethod1;
use MockeryTest\Fixture\MockeryTest_SubjectCall1;
use MockeryTest\Fixture\MyService2;
use MockeryTest\Mockery\RegExpCompatability;

class ExpectationTest extends \Mockery\Adapter\Phpunit\MockeryTestCase
{
    ...
    {
        $this->assertInstanceOf(\Mockery\MockInterface::class, \mock('f')->byDefault());
    }
    ...
    {
        $this->mock->shouldReceive('foo')->with(\Mockery::subset(['a'=>1, 'b'=>2]));
        $this->expectException(\Mockery\Exception::class);
    ...
    {
        $service = $this->createMock(MyService2::class);
    ...
    public function it_uses_a_matchers_to_string_method_in_the_exception_output()
    {
        ...
        $this->expectException(
            \Mockery\Exception\InvalidCountException::class,
