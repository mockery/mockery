...
{
    final const DUMMY_METHOD_DEFINITION_LEGACY = 'public function unserialize($string) {} ';
    final const DUMMY_METHOD_DEFINITION = 'public function unserialize(string $data): void {} ';
