...
class Expectation
{
    ...
    /**
     * Set a return value that is an iterator over the provided array
     *
     * @return self
     */
    public function andReturnIterator(array $values)
    {
        $this->_returnQueue = array(new \ArrayIterator($values));
        return $this;
    }
