...
<package xmlns="http://pear.php.net/dtd/package-2.0" xmlns:tasks="http://pear.php.net/dtd/tasks-1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://pear.php.net/dtd/tasks-1.0         http://pear.php.net/dtd/tasks-1.0.xsd http://pear.php.net/dtd/package-2.0 http://pear.php.net/dtd/package-2.0.xsd" version="2.0">
    ...
    <dir name="/" baseinstalldir="/">
      <dir name="library">
        ...
        <dir name="Mockery">
          ...
          <dir name="Generator">
            <file name="CachingGenerator.php" role="php"/>
            <file name="DefinedTargetClass.php" role="php"/>
            <file name="Generator.php" role="php"/>
            <file name="Method.php" role="php"/>
            <file name="MockConfiguration.php" role="php"/>
            <file name="MockConfigurationBuilder.php" role="php"/>
            <file name="MockDefinition.php" role="php"/>
            <file name="Parameter.php" role="php"/>
            <dir name="StringManipulation">
                <dir name="Pass">
                    <file name="CallTypeHintPass.php" role="php"/>
                    <file name="ClassNamePass.php" role="php"/>
                    <file name="ClassPass.php" role="php"/>
                    <file name="InstanceMockPass.php" role="php"/>
                    <file name="InterfacePass.php" role="php"/>
                    <file name="MethodDefinitionPass.php" role="php"/>
                    <file name="Pass.php" role="php"/>
                    <file name="RemoveBuiltinMethodsThatAreFinalPass.php" role="php"/>
                </dir>
            </dir>
            <file name="StringManipulationGenerator.php" role="php"/>
            <file name="TargetClass.php" role="php"/>
            <file name="UndefinedTargetClass.php" role="php"/>
          </dir>
          <file name="Loader.php" role="php"/>
          <dir name="Loader">
            <file name="EvalLoader.php" role="php"/>
            <file name="Loader.php" role="php"/>
            <file name="RequireLoader.php" role="php"/>
          </dir>
          <dir name="Matcher">
  ...
  <phprelease>
    <filelist>
      ...
      <install name="library/Mockery/Generator/CachingGenerator.php" as="Mockery/Generator/CachingGenerator.php"/>
      <install name="library/Mockery/Generator/DefinedTargetClass.php" as="Mockery/Generator/DefinedTargetClass.php"/>
      <install name="library/Mockery/Generator/Generator.php" as="Mockery/Generator/Generator.php"/>
      <install name="library/Mockery/Generator/Method.php" as="Mockery/Generator/Method.php"/>
      <install name="library/Mockery/Generator/MockConfiguration.php" as="Mockery/Generator/MockConfiguration.php"/>
      <install name="library/Mockery/Generator/MockConfigurationBuilder.php" as="Mockery/Generator/MockConfigurationBuilder.php"/>
      <install name="library/Mockery/Generator/MockDefinition.php" as="Mockery/Generator/MockDefinition.php"/>
      <install name="library/Mockery/Generator/Parameter.php" as="Mockery/Generator/Parameter.php"/>
      <install name="library/Mockery/Generator/StringManipulation/Pass/CallTypeHintPass.php" as="Mockery/Generator/StringManipulation/Pass/CallTypeHintPass.php"/>
      <install name="library/Mockery/Generator/StringManipulation/Pass/ClassNamePass.php" as="Mockery/Generator/StringManipulation/Pass/ClassNamePass.php"/>
      <install name="library/Mockery/Generator/StringManipulation/Pass/ClassPass.php" as="Mockery/Generator/StringManipulation/Pass/ClassPass.php"/>
      <install name="library/Mockery/Generator/StringManipulation/Pass/InstanceMockPass.php" as="Mockery/Generator/StringManipulation/Pass/InstanceMockPass.php"/>
      <install name="library/Mockery/Generator/StringManipulation/Pass/InterfacePass.php" as="Mockery/Generator/StringManipulation/Pass/InterfacePass.php"/>
      <install name="library/Mockery/Generator/StringManipulation/Pass/MethodDefinitionPass.php" as="Mockery/Generator/StringManipulation/Pass/MethodDefinitionPass.php"/>
      <install name="library/Mockery/Generator/StringManipulation/Pass/Pass.php" as="Mockery/Generator/StringManipulation/Pass/Pass.php"/>
      <install name="library/Mockery/Generator/StringManipulation/Pass/RemoveBuiltinMethodsThatAreFinalPass.php" as="Mockery/Generator/StringManipulation/Pass/RemoveBuiltinMethodsThatAreFinalPass.php"/>
      <install name="library/Mockery/Generator/StringManipulationGenerator.php" as="Mockery/Generator/StringManipulationGenerator.php"/>
      <install name="library/Mockery/Generator/TargetClass.php" as="Mockery/Generator/TargetClass.php"/>
      <install name="library/Mockery/Generator/UndefinedTargetClass.php" as="Mockery/Generator/UndefinedTargetClass.php"/>
      <install name="library/Mockery/Loader.php" as="Mockery/Loader.php"/>
      <install name="library/Mockery/Loader/EvalLoader.php" as="Mockery/Loader/EvalLoader.php"/>
      <install name="library/Mockery/Loader/Loader.php" as="Mockery/Loader/Loader.php"/>
      <install name="library/Mockery/Loader/RequireLoader.php" as="Mockery/Loader/RequireLoader.php"/>
